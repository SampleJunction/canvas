<template>
    <div v-cloak>
        <div class="modal fade" id="thumbnail_image-upload" tabindex="-1" role="dialog" data-backdrop="static">
            <div class="modal-dialog" id="thumbnail_unsplash-modal" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <div class="col-lg-12">
                                <div v-if="imageUrl" id="thumbnail_current-image">
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.$parent.$on('openingThumbnailUploader', data => {
                if (data) {
                    this.toggleModal();
        ...
        methods: {
            // Show/hide the modal
            toggleModal() {
                $('#thumbnail_image-upload').modal('show');
            },
