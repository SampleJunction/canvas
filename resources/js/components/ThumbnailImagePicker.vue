...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            openUnsplashModal() {
                if (document.querySelector('#thumbnail_image-unsplash-modal')) {
                    document.querySelector('#thumbnail_image-unsplash-modal').classList.add('modal-lg');
                }
                if (document.querySelector('#thumbnail_unsplash-modal')) {
                    document.querySelector('#thumbnail_unsplash-modal').classList.add('modal-lg');
                }
                if (document.querySelector('#thumbnail_current-image')) {
                    document.querySelector('#thumbnail_current-image').classList.add('d-none');
                }
            ...
            closeUnsplashModal() {
                if (document.querySelector('#thumbnail_image-unsplash-modal')) {
                    document.querySelector('#thumbnail_image-unsplash-modal').classList.remove('modal-lg');
                }
                if (document.querySelector('#thumbnail_unsplash-modal')) {
                    document.querySelector('#thumbnail_unsplash-modal').classList.remove('modal-lg');
                }
                if (document.querySelector('#thumbnail_current-image')) {
                    document.querySelector('#thumbnail_current-image').classList.remove('d-none');
                }
